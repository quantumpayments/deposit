...
var debug    = require('debug')('qpm_deposit:clear')
var fs       = require('fs')
            ...
            if (err) {
              ...
              wc.deposit(credit, sequelize, config, function(err, cleared) {
                ...
                if (err) {
                  ...
                  var body = `
                  <div>
                  Cleared funds : ` + bal*1000000 + `
                  <a href="/">Home</a> | <a href="/deposit">Deposit</a> | <a href="/clear">Clear</a> | <a href="/toledger">To Ledger</a> | <a href="/sweep">Sweep</a>
                  </div>
                  `
